...
const SOCIAL_LINK_ITEMS: CommandLinkItem[] = SOCIAL_LINKS.filter(
  (item): item is typeof item & { icon: string } =>
...
// posts prop is reserved for future use when components are re-enabled
